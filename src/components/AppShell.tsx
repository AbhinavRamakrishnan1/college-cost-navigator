    ...
    <div className="min-h-screen">
      ...
      <header className="border-b border-line bg-paper/95 backdrop-blur">
        <div className="page-wrap flex min-h-18 items-center justify-between gap-4">
          ...
          <button type="button" className="rounded-md border border-line bg-white px-3 py-2 text-sm font-bold lg:hidden" aria-expanded={open} aria-controls="mobile-menu" onClick={() => setOpen((value) => !value)}>{open ? 'Close' : 'Menu'}</button>
        </div>
