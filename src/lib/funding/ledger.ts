...
const rateKey = { direct_subsidized: 'directSubsidizedUndergrad', direct_unsubsidized: 'directUnsubsidizedUndergrad', parent_plus: 'directPlusParentOrGradProfessional' } as const

export function buildLoanLedgerEntry(input: { loanId: string; borrowerId: string; borrowerRole: 'student' | 'parent'; studentBeneficiaryId: string; loanType: LoanKind; academicYear: string; schedule: LoanSchedule }): LoanLedgerEntry | { status: 'requires_assumption'; reasons: string[] } {
